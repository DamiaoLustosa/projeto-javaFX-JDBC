...
public class DepartmentListController implements Initializable {
	...
	private void initializeNodes() {
		...
		//Fazer a tabela acompanhar as dimensões da tela
	...
	private void createDialogForm(String absoluteName, Stage parentStage) {
		try {
			...
			dialogStage.setTitle("Janela Modal -- Entre com os dados do departamento!");
			dialogStage.setScene(new Scene(pane));
			dialogStage.setResizable(false); //não pode ser redimensionada
			dialogStage.initOwner(parentStage); //Pai da janela modal
